...
11. [DIRECT EXECUTION & ZERO REDUNDANT VIEWING]: All relevant target files and outlines are pre-injected directly into this prompt. Do NOT call view_file repeatedly on files whose code or outline is already provided above. Proceed directly to modify the target files using write_to_file or replace_file_content and complete the requested task decisively.
