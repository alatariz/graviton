...
async function main() {
  ...
  console.log('\x1b[1;36m[Graviton V2.6.0 Active]\x1b[0m');
...
`);
  ...
  if (command === 'version' || command === '--version' || command === '-v') {
    ...
    console.log(`\x1b[1m\x1b[36mGRAVITON\x1b[0m v${version} (Graviton V2.6.0 Stack Squeezer & Output Economizer)`);
    process.exit(0);
  }
