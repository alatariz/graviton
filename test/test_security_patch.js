...
try {
  ...
  assert.strictEqual(linuxConfig.spawnCmd, 'antigravity', 'On Linux, spawnCmd must be base command');
  ...
  console.log('  ✔ Non-Windows platforms (Linux/macOS) use base command with originalArgs');
} finally {
